...
func TestGetPayments(t *testing.T) {
	...
	Convey("Given payments", t, func() {
		mock.ExpectQuery("SELECT").WillReturnRows(sqlmock.NewRows([]string{"id"}).
			...
			AddRow("216d4da9-e59a-4cc6-8df3-3da6e7580b77").
			AddRow("7eb8277a-6c91-45e9-8a03-a27f82aca350").
			AddRow("97fe60ba-1334-439f-91db-32cc3cde036a").
			AddRow("ab4bbd28-33c6-4231-9b64-0e96190f59ef").
			AddRow("7f172f5c-f810-4ebe-b015-cb1fc24c6b66").
			AddRow("502758ff-505f-4d81-b9d2-83aa9c01ebe2").
			AddRow("09fe827a-b3c2-4437-b999-6c0e780c0983").
			AddRow("de1f6882-4dba-485a-a632-a80f59fbe4a6").
			AddRow("b71afd98-4fba-40a4-b8f3-087d005187e3").
			AddRow("dbb89036-4007-47ff-8fab-00bdd5cc4021").
			AddRow("52611302-0758-4f69-aa15-c5f55ab7c3eb").
			AddRow("6cd862ab-6d40-4a86-8037-77d446b3f6fc").
			AddRow("09a8fe0d-e239-4aff-8098-7923eadd0b98"))
